...
Rendimods / putra mods

📝 | Created By RendiMods
🖥️ | Base Ori By RendiMods
...
await ryozingod.updateProfileStatus(`✳️ Ucenn+ || ✅ Runtime : ${uptime}`)
...
sourceUrl: `https://youtube.com/@RendiWangsaff`,
mediaUrl: `https://youtube.com/@RendiWangsaff`
}
},
text: teks
}, {
...
Creator : 𝖠𝗄𝗎𝗅𝖺𝗁𝖡𝗈𝗒𝗌
Team: 𝗄𝖿𝗅𝗂,𝗃𝗈𝗌𝖾,𝖾𝗉𝖺𝗇,𝗐𝗂𝗅𝖽𝖺𝗇
Type : Plugins
Mode : ${ryozingod.public ? '𝖯𝗎𝖻𝗅𝗂𝖼' : '✲ Self ༣'}
...
┏❐  ⌜ Cenn - Bot ⌟  ❐
┃⭔ Creator : By Ucenn+
┃⭔ patner : 𝗄𝖿𝗅𝗂,𝗃𝗈𝗌𝖾,𝖾𝗉𝖺𝗇,𝗐𝗂𝗅𝖽𝖺𝗇,ucenn
┃⭔ Type : Case
┃⭔ Status : Ready
...
//=================================================//
case 'sc': case 'script': {
joreply(`🌤️Sc Ini Dibuat Oleh By Ucenn+.
...
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ 𝐔𝐜𝐞𝐧𝐧 ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ 𝐔𝐜𝐞𝐧𝐧 ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nEND:VCARD`,
}
...
if (!text) return joreply(`*Example: ${prefix+command} https://youtube.com/@RendiWangsaff*`)
